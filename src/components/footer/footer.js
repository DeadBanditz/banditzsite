                ...
                <Container className='footer'>
                    ...
                    <div>
                       ...
                       <a style={{textDecoration: "none", color:"white"}}target="_blank" rel="noopener noreferrer"href="https://discord.com/"> <BsDiscord size={32} />   </a>      */}
                        ...
                        <p><a target="_blank" rel="noopener noreferrer" href="https://deadbanditz.github.io/TermsAndConditions/" style={{ textDecoration: "none", color: "#E8B331", textAlign: "right" }}><text className="metaverse">Terms and Conditions</text></a></p>
